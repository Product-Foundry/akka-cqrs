...
class SimpleAggregateFactory[A <: Aggregate[_] : ClassTag] extends AggregateFactory[A] {
...
object SimpleAggregateFactory {
  def supervisor[A <: Aggregate[_] : ClassTag](implicit domainContext: DomainContext): ActorRef = {
